...
<footer class="bg-stats4sd-grey py-12">
    <div class="max-w-screen-lg 2xl:max-w-screen-xl 3xl:max-w-screen-2xl px-12 sm:px-24 md:px-16 2xl:px-24  mx-auto ">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 text-white text-sm">
            ...
            <div class="md:col-span-4 ">
                ...
                <div class="md:col-span-2  text-right">
                    <a href="/admin" class="w-36 mt-2 button bg-black text-white text-center py-2 px-8 rounded-full">Staff Login</a>
                </div>
            </div>
        </div>
    </div>

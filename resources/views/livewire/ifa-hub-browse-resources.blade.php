<div>
    ...
    <div class="w-full flex justify-center py-6 px-12">
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4 justify-left max-w-7xl px-12">
            ...
            <div id="Resources-content" class="p-8 rounded-lg">
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    @foreach ($resources as $resource)
                        <x-resource-result-card :item="$resource" color="ifa-yellow" textcol="black" target="_self" :show-tags="false"/>

        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 justify-left max-w-7xl px-12">
            ...
            @if ($featureCount < 11)
                ...
                <label
                    ...
                    class="hover-effect cursor-pointer flex justify-between items-center relative bg-ifa-yellow rounded-full  overflow-hidden group sm:max-w-[20rem] min-w-[14rem] text-black text-sm h-20 px-6 py-4">
                    {{ $t['name'] }}
